...
injured_people = st.slider("Number of persons injured invehicle collisions",0,19)
...
if select =='Pedestrians':
    ...
    st.write(original_data.query("injured_cyclist>=1")[["on_street_name","injured_cyclists"]].sort_values(by=['injured_cyclist'],ascending=False).dropna(how='any')[:5])
...
if st.checkbox("ShowRaw Data", False):
